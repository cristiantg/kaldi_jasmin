...
if (len(sys.argv) < 3):
    print("You must add 2 arguments: input file (utf-8) and output file paths")
    print("e.g. python3 text_filter.py $my_dir/data/train/text $my_dir/data/train/text_filter")
    sys.exit(-1)
...
with open(input_file, 'r', encoding='utf-8') as input_text:
    for line in input_text:
        ...
        filtered_lines.append(id+TEXT_SEPARATOR+' '.join(filtered_utt))
