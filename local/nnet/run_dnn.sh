...
# Config:
gmmdir=exp/tri3
data_fmllr=data-fmllr-tri4_nnet
...
if [ $stage -le 0 ]; then
  ...
  #   --transform-dir $gmmdir/decode_dev93 \
...
if [ $stage -le 2 ]; then
  ...
  #  $gmmdir/graph $data_fmllr/test_dev93 $dir/decode_dev93 || exit 1;
...
if [ $stage -le 4 ]; then
  ...
  for ITER in 5 4 3 1; do
    ...
    #  $gmmdir/graph $data_fmllr/test_dev93 $dir/decode_dev93_it${ITER} || exit 1;
